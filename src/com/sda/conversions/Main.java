...
public class Main {
    public static void main(String[] args) {
        ...
        long numarLong3 =  123456789012345678L;
        ...
        // 4. long - float (cu pierdere, dar implicit)


        // 5. char - int
        char character5 = 'D';
        int numarInt5 = character5;
        System.out.println("Caracterul: " + character5 + "; Numar int: " + numarInt5);
        ...
        // 0000 0000 0000 0000 0000 0000 1100 1000 - >  reprezentarea pe 32 biti - > pt int

        //daca priumul bit e de la stanga este 1, inseamna ca numarul nostru este negativ
        ...
        // pentru ca bitul de semn a fost 1, stim ca numarul este negativ => -56

        // 8. double - float
        double numarDouble8 = 10.34d;
        float numarFloat8 = (float) numarDouble8;
        System.out.println(numarFloat8);


        /*
        //test floating - int
        System.out.println("text experiment " + (int) 10.7);
        //long - double without it being assigned to a variable
        System.out.println("text experiment " + (double) numarLong);
        //test long-double
        double numar = (double) numarLong;

        double numar1 = numarLong;
